...
<div class="project-hero scroll-animation" id="project-hero--grenzkunst">
    <img src="" data-src="/img/grenzkunst/grenzkunst-01.jpg" alt="grenzkunst-hero" sizes="auto">
</div>
...
<div class="project-content">
    ...
    <div class="project-box img-l shift scroll-animation">
        ...
        <p class="img-description">
            <?php if ($lang == 'de'): ?>
                Das variable Designsystem: Muster, Farbschema und Typographie-Raster.
            <?php else: ?>
                Simple, extendable design system: pattern, colour scheme, type grid.
            <?php endif ?>
        </p>
